...
class DatabaseCopy2019_02_23_17_11_42
{
...
PRIMARY KEY (id)
  ...
  3 => 'INSERT INTO _users VALUES(\'1\', \'slavamnem\', \'1234\', \'Slava Zelinskiy\', \'2018-12-18\'), (\'2\', \'vladik123\', \'1234\', \'Vlad Butnaru\', \'2018-12-18\'), (\'3\', \'dimka8\', \'333555\', \'Dima Hutor\', \'2018-12-03\'), (\'4\', \'oleg\', \'1234\', \'Oleg Petrov\', \'2018-12-12\'), (\'5\', \'nasta\', \'1234\', \'Nasta Ivanova\', \'2018-12-12\')',
    ...
    public static function restoreTables()
    {
        ...
        while (count($doneQueries) < count(self::$createTablesSqls)){
            foreach (self::$createTablesSqls as $query) {
                if (!in_array($query, $doneQueries)) {
                    try {
                        dump($query);
    ...
    public static function fillTables()
    {
        $doneQueries = [];

        while (count($doneQueries) < count(self::$insertDataSqls)){
            foreach (self::$insertDataSqls as $query) {
                if (!in_array($query, $doneQueries)) {
                    try {
                        dump($query);
                        $stmp = PdoHelper::getPdo()->prepare($query);
...
//    {
//
//        $allQueries = array_merge(self::$createTablesSqls, self::$insertDataSqls);
//
//        $allQueries = array_merge([self::$createTablesSqls[0]], [self::$insertDataSqls[3]]);
//        $allQueries = array_merge([self::$createTablesSqls[1]], [self::$insertDataSqls[1]]);
//        $allQueries = [self::$insertDataSqls[1]];
